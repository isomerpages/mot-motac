 ...
 <div class="container-fluid py-5 text-pri card-bg my-5">
   ...
   <div class="row">
     ...
     <div class="col-sm-8 mx-auto text-center py-3">
       <img src="/images/MI/IM8/Iconic Picture.png" class="img-fluid border my-5" />
     </div>
   </div>
   <div class="row">
     ...
     <div class="col-sm-6 text-center mx-auto py-3">
       <img src="/images/MI/IM8/Group Photo.jpg" class="img-fluid border border-5 border-secondary" alt="" />
     </div>
     <div class="col-sm-11 mx-auto my-3">
       <div class="row py-5">
         <div class="col-sm-6 mb-5">
           <div class="row">
             <div class="col-sm-6">
               <p class="mb-2 text-pri font-weight-bold">Vincent Ong </p>
             </div>
             <div class="col-sm-6">
           ...
           <div class="row">
             <div class="col-sm-6">
               <p class="mb-2 text-pri font-weight-bold">Capt. Andy Chew</p>
             </div>
             <div class="col-sm-6">
               <p class="mb-2 text-pri font-weight-bold">Team Lead</p>
             </div>
           ...
           <div class="row">
             <div class="col-sm-6">
               <p class="mb-2 text-pri font-weight-bold">Capt. Charles</p>
             </div>
             <div class="col-sm-6">
         ...
         <div class="col-sm-6 mb-5">
           <div class="row">
             <div class="col-sm-6">
               <p class="mb-2 text-pri font-weight-bold">Capt. Scott Ngiam</p>
             </div>
             <div class="col-sm-6">
           ...
           <div class="row">
             <div class="col-sm-6">
               <p class="mb-2 text-pri font-weight-bold"> Capt. Andrew Leong </p>
             </div>
             <div class="col-sm-6">
               <p class="mb-2 text-pri font-weight-bold">Team Member</p>
             </div>
   ...
   <nav>
     <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
       <a class="nav-link active text-uppercase link-home text-decoration-none" id="nav-home-tab" href="/minister-innovation-award/IM8/home/">
