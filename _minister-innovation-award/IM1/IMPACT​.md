...
<div class="container-fluid py-5 card-bg text-pri my-5">
      ...
      <div class="row py-2">
        <div class="col-sm-11 mx-auto">
          <ol>
            ...
            <li> The programme also provides Singapore with an opportunity to show our thought leadership and served as a platform for us to engage with DGs around the world before the ICAO Assembly, in a cost-effective manner. </li>
            <li> Media Management and Publicity - The CAS and associated aviation news dominated daily media headlines from 15 to 20 May. A total of 86 local and foreign media stories were generated. This included 7 Front Page media stories. A total of 76 social media impressions relating to the summit included posts on Twitter and Facebook shared by participating organisations and civil aviation authorities such as Nicholas Robinson, Director General of Civil Aviation at Transport Canada, Federal Aviation Administration (FAA), Civil Aviation Authority of Philippines and Boeing </li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 py-2">
      <p class="mb-2 font-weight-bold text-pri"> A project whereby innovative elements have been fused into a conference to make for a compelling engagement platform for our key stakeholders. </p>
    </div>
  </div>
  <nav>
    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
      ...
      <a class="nav-link active link-impact text-decoration-none text-uppercase" id="nav-impact-tab" href="/minister-innovation-award/IM1/impact/"> Impact</a>
    </div>
  </nav>
</div>