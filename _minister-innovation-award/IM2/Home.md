...
<div class="container-fluid py-5 text-pri card-bg my-5">
  ...
  <div class="row">
    ...
    <div class="col-sm-8 mx-auto text-center py-3">
      <img src="/images/MI/IM2/C-UAS OCC Iconic Picture.jpg" class="img-fluid border my-5" />
    </div>
  </div>
  <div class="row">
    ...
    <div class="col-sm-6 text-center mx-auto py-3">
      <img src="/images/MI/IM2/CAAS_CUAS OCC_Project Team.png" class="img-fluid border border-5 border-secondary" alt="" />
    </div>
      ...
      <div class="row py-5">
        <div class="col-sm-6 mb-5">
          <div class="row">
            ...
            <div class="col-sm-6">
              <p class="mb-2 text-pri font-weight-bold">Alex Chong</p>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <p class="mb-2 text-pri font-weight-bold">Zhihua SU</p>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <p class="mb-2 text-pri font-weight-bold">Kavi Prem SINGH</p>
            </div>
          </div>
        </div>
        <!-- //Second Line Code -->
        <div class="col-sm-6 mb-5">
          <div class="row">
            ...
            <div class="col-sm-6">
              <p class="mb-2 text-pri font-weight-bold">Gerald TAN</p>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <p class="mb-2 text-pri font-weight-bold">Jaric THAM</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <nav>
    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
      <a class="nav-link active text-uppercase link-home text-decoration-none" id="nav-home-tab" href="/minister-innovation-award/IM2/home/">
