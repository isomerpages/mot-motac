...
<div class="container-fluid py-5 text-pri card-bg my-5">
  ...
  <div class="row">
    ...
    <div class="col-sm-8 mx-auto text-center py-3">
      <img src="/images/MI/IM12/Iconic picture.jpg" class="img-fluid border my-5" />
    </div>
  </div>
  <div class="row">
    ...
    <div class="col-sm-8 text-center mx-auto py-3">
      <img src="/images/MI/IM12/team photo.jpg" class="img-fluid border border-5 border-secondary" alt="" />
    </div>
  ...
  <nav>
    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
      <a class="nav-link active text-uppercase link-home text-decoration-none" id="nav-home-tab" href="/minister-innovation-award/IM12-SM/home/">
