 ...
 <h3 class="text-center font-weight-bold text-uppercase"> Cross Island Line (CRL) ​ <br /> Train Fleet Size Optimisation </h3>
    ...
    <div class="col-sm-12">
      <div class="row py-2">
        <div class="col-sm-8">
          <p>
            <span class="mr-3"> &#x2022;</span>Optimise Operation Parameters:​
          </p>
          <p class="pl-5">
            <span class="mr-3"> &#x2022;</span> Increase in maximum design speed of train from 90kph to 100kph.
          </p>
          <p class="pl-5">
            <span class="mr-3"> &#x2022;</span> Reduce coasting margin from 8% to 5%.
          </p>
          <p class="pl-5">
            <span class="mr-3"> &#x2022;</span> Achieve better certainty in alignment between Advanced Engineering Study Design vs Feasibility Design.
          </p>
        </div>
        <div class="col-sm-4">
          <img src="/images/VFM/VM3/VM3 Solution1.png" class="img-fluid" alt="" />
        </div>
      </div>
      <div class="row py-2">
        <div class="col-sm-8">
          <p>
            <span class="mr-3"> &#x2022;</span> Implement Inner Loop – Outer Loop Operating pattern.
          </p>
        </div>
        <div class="col-sm-4">
          <img src="/images/VFM/VM3/VM3 Solution2.png" class="img-fluid border border-5 border-primary" alt="" />
        </div>
      </div>
      <div class="row py-2">
        <div class="col-sm-8">
          <p>
            <span class="mr-3"> &#x2022;</span> Revise approach in calculating train spares.
          </p>
        </div>
        <div class="col-sm-4">
          <img src="/images/VFM/VM3/VM3 Solution3.png" class="img-fluid border border-5 border-secondary" alt="" />
        </div>
      </div>
    </div>
  </div>
  <div class="row">
    ...
    <div class="col-sm-12 py-2">
      <p class="mb-0 font-weight-bold text-pri"> Match projected ridership demand with Operation and Maintenance needs and supply of trains and infrastructure to ensure a more cost-effective operating pattern for the CRL as a whole. </p>
    </div>
  </div>
  <nav>
