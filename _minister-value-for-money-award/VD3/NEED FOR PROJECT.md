    ...
    <div class="col-sm-12 py-4">
      <div class="row py-2">
        ...
        <div class="col-sm-12 py-2">
          <p>
            <span class="mr-3"> &#x2022;</span> Utility diversions are required to safely construct MRT station but they are costly. ​
          </p>
          <p>
            <span class="mr-3"> &#x2022;</span> Normally, utilities have to be diverted far from the MRT station along routes that are far longer than the length of the existing utilities. ​
          </p>
          <p>
            <span class="mr-3"> &#x2022;</span> It is desirable to reduce the length of the utility diversion routes in order that: ​
          </p>
          <p class="pl-3">
            <span class="mr-3"> &#x2022;</span> The Cross Island Line - Punggol Extension (CPe) MRT station construction remain within budget.​
          </p>
          <p class="pl-3">
            <span class="mr-3"> &#x2022;</span> The utilities diversions are completed on time so as not to delay MRT station construction works. ​
          </p>
          <p>
            <span class="mr-3"> &#x2022;</span>The challenge is that there is limited space to divert utilities along a shorter route around the future MRT stations in congested areas with many buildings close by and station structures that extend beyond the road reserve lines. ​
          </p>
        </div>
      </div>
    </div>
