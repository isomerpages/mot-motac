     ...
     <div class="col-sm-12">
       <div class="row py-2">
         <div class="col-sm-11 mx-auto text-center">
           <img src="/images/VFM/VM3/VM3 Impact.jpg" class="img-fluid border border-5 border-primary" alt="" />
         </div>
         <div class="col-sm-12 py-2 mx-auto">
           <ul class=" text-pri">
             <li>
               <p> The optimisation of operation parameters and implementation of Inner Loop – Outer Loop Operating pattern will require 30 fewer trains for the entire CRL.​ </p>
             </li>
             <li>
               <p> No delay to completion of project from implementing Inner Loop – Outer Loop Operating pattern due to early identification and planning of the work duration and resources in the work programme​ </p>
             </li>
             <li class="font-weight-bold">
               <p>Total Cost Savings: $426mil.​</p>
             </li>
           </ul>
         </div>
       </div>
