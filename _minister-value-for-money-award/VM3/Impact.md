...
<div class="container-fluid py-5 card-bg text-pri my-5">
    ...
    <div class="col-sm-12">
      <div class="row py-2">
        ...
        <div class="col-sm-12 py-2 mx-auto">
          ...
          <p>
            <span class="mr-3"> &#x2022;</span> The successful management of the aviation height restriction serves as an encouragement for other project teams to challenge the “norm” and optimise works or processes to minimise costs.
          </p>
          <p class="font-weight-bold">
            <span class="mr-3"> &#x2022;</span> Total Cost Savings (Omission of Civil Works and Utility Diversions): $16.81mil. ​
          </p>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 py-2">
      <p class="mb-0 font-weight-bold text-pri"> The relaxation of aviation height control led to the omission of related civil works and utility diversions, as well as cost minimisation. </p>
    </div>
  </div>
  <nav>
    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
      ...
      <a class="nav-link link-impact active text-decoration-none" id="nav-impact-tab" href="/minister-value-for-money-award/VM3/impact/"> IMPACT</a>
    </div>
  </nav>
</div>