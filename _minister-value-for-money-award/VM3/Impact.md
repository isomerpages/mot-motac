    ...
    <div class="col-sm-12">
      <div class="row py-2">
        ...
        <div class="col-sm-12 py-2 mx-auto">
          <p>
            <span class="mr-3"> &#x2022;</span> The optimisation of operation parameters and implementation of Inner Loop – Outer Loop Operating pattern will require 30 fewer trains for the entire CRL.​
          </p>
          <p>
            <span class="mr-3"> &#x2022;</span> No delay to completion of project from implementing Inner Loop – Outer Loop Operating pattern due to early identification and planning of the work duration and resources in the work programme​
          </p>
          <p class="font-weight-bold">
            <span class="mr-3"> &#x2022;</span>Total Cost Savings: $426mil.​
          </p>
        </div>
      </div>
    </div>
