     ...
     <div class="col-sm-12">
       <div class="row py-2">
         <div class="col-sm-8">
           <ul class=" text-pri">
             <li>
               <p>Optimise Operation Parameters:​</p>
               <ul>
                 <li>
                   <p> Increase in maximum design speed of train from 90kph to 100kph. </p>
                 </li>
                 <li>
                   <p> Reduce coasting margin from 8% to 5%. </p>
                 </li>
                 <li>
                   <p> Achieve better certainty in alignment between Advanced Engineering Study Design vs Feasibility Design. </p>
                 </li>
               </ul>
             </li>
           </ul>
       ...
       <div class="row py-2">
         <div class="col-sm-8">
           <ul class=" text-pri">
             <li>
               <p> Implement Inner Loop – Outer Loop Operating pattern. </p>
             </li>
           </ul>
         </div>
         <div class="col-sm-4">
       ...
       <div class="row py-2">
         <div class="col-sm-8">
           <ul class=" text-pri">
             <li>
               <p> Revise approach in calculating train spares. </p>
             </li>
           </ul>
         </div>
         <div class="col-sm-4">
