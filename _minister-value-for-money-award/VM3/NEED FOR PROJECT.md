    ...
    <div class="col-sm-12">
      <div class="row py-2">
        ...
        <div class="col-sm-11 py-2 mx-auto">
          <p>
            <span class="mr-3"> &#x2022;</span>An initial fleet size of more than 80 trains was proposed for the Cross Island Line (CRL) to allow the CRL to operate (end-to-end pattern) at a 2.5-minute headway for Mainline, and 4-minute headway for CRL Punggol extension.
          </p>
          <p>
            <span class="mr-3"> &#x2022;</span> The initial trains procurement strategy may not closely match the projected demands, especially when demand may not be uniform across the entire CRL. ​
          </p>
          <p>
            <span class="mr-3"> &#x2022;</span> To ensure better use of resources, there is thus a need to review how operating parameters can be optimised to provide a more accurate estimate for quantity of trains needed to support operations, and leveraging on experience gained from past MRT lines.​
          </p>
        </div>
      </div>
    </div>
