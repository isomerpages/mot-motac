    ...
    <div class="col-sm-12">
      <div class="row py-2">
        ...
        <div class="col-sm-12 py-2 mx-auto">
          <p>
            <span class="mr-3"> &#x2022;</span> Avoided significant costs in full-scale implementation of a new base-station site. ​
          </p>
          <p>
            <span class="mr-3"> &#x2022;</span> Effective in resolving the base-station coverage problem as there was no more adverse feedback received from VTM operators & vessels in the PPC sector after relocating the antennas at AC and VISTA radio base-station sites.​
          </p>
          <p>
            <span class="mr-3"> &#x2022;</span> Resolved the problem within seven weeks, which significantly reduced the operational risk exposure when compared with the 18-month duration of a typical full-scale project implementation of a new base-station site.​
          </p>
          <p class="font-weight-bold">
            <span class="mr-3"> &#x2022;</span>Total Time Savings: ~16 months.​
          </p>
          <p class="font-weight-bold">
            <span class="mr-3"> &#x2022;</span>Total Cost Savings: $277,000. ​
          </p>
        </div>
      </div>
    </div>
