 ...
 <div class="container-fluid py-5 card-bg text-pri my-5">
     ...
     <div class="col-sm-12">
       ...
       <div class="row py-2">
         <div class="col-sm-8">
           <ul class=" text-pri">
             <li>
               <p> VHF base-station coverage to Pasir Panjang Control (PPC) Sector had degraded over the years. This affected the safety of navigation within the areas.​ </p>
             </li>
             <li>
               <p> This was due to blockage of vessels’ line-of-sight (LOS) with the VHF base-stations, which was possibly caused by the shadowing-effect of the nearby tall buildings and metallic structures that were erected along the PPC sector coastlines from our past years of port infrastructure development.​ </p>
             </li>
           </ul>
         </div>
         <div class="col-sm-4">
           <img src="/images/VFM/VM5/VM5_NeedforProject_2.png" class="img-fluid border border-5 border-secondary" alt="" />
         </div>
       </div>
       <div class="row py-2">
         <div class="col-sm-8 text-center mx-auto">
           <img src="/images/VFM/VM5/VM5_NeedforProject_3.png" class="img-fluid border border-5 border-secondary" alt="" />
         </div>
       </div>
     </div>
   </div>
   ...
   <nav>
     <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
       ...
       <a class="nav-link link-project active text-decoration-none" id="nav-project-tab" href="/minister-value-for-money-award/VM5/need-for-project/"> NEED FOR <br /> PROJECT </a>
