...
<div class="container-fluid py-5 text-pri card-bg my-5">
  ...
  <div class="row">
    ...
    <div class="col-sm-8 mx-auto text-center border border-primary pu-3">
      <video width="100%" controls>
        <source src="/images/VFM/VM4/VM4_IconicPic [VIDEOCLIP].mp4" type="video/mp4" />
      </video>
      <img src="/images/VFM/VM4/VM4_IconicPic [benefitspts].png" class="img-fluid" alt="" />
    </div>
  </div>
  <div class="row">
    ...
    <div class="col-sm-6 mx-auto text-center py-3">
      <img src="/images/VFM/VM4/VM4 Team Photo 2.jpg" class="img-fluid border my-5" />
    </div>
  ...
  <nav>
    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
      <a class="nav-link active text-uppercase link-home text-decoration-none" id="nav-home-tab" href="/minister-value-for-money-award/VM4/home/">
