      ...
      <div class="row py-2">
        ...
        <div class="col-sm-12">
          <div class="row py-2">
            <div class="col-sm-8">
              <p>
                <span class="mr-3"> &#x2022;</span> Water Mist System used less resources such as land space and allowed for faster installation due to smaller pipe sizes as compared to Deluge System, without compromising on the project objectives.
              </p>
            </div>
            <div class="col-sm-4">
