...
<div class="container-fluid py-5 card-bg text-pri my-5">
  ...
  <div class="row">
    ...
    <div class="col-sm-11 mx-auto">
      <div class="row py-2 border border-5 border-primary">
        <div class="col-sm-8">
          <img src="/images/VFM/VM4/VM4_Solution_1.png" class="img-fluid" alt="" />
        </div>
        <div class="col-sm-4">
          <img src="/images/VFM/VM4/VM4_Solution_2.png" class="img-fluid" alt="" />
        </div>
      </div>
      <div class="row py-2">
        <div class="col-sm-8">
  ...
  <div class="row">
    ...
    <div class="col-sm-12 py-2">
      <p class="mb-0 font-weight-bold text-pri"> Installed the Water Mist System which had met and exceeded the project objectives of enhancing tunnel fire safety, while working within the given constraints of KPE and CTE tunnels. </p>
    </div>
  </div>
  <nav>
    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
      ...
      <a class="nav-link link-solution active text-decoration-none" id="nav-solution-tab" href="/minister-value-for-money-award/VM4/solution/"> SOLUTION</a>
