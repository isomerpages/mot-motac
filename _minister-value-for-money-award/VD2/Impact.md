...
<div class="container-fluid py-5 card-bg text-pri my-5">
  ...
  <div class="row">
    ...
    <div class="col-sm-12 py-2">
      <p class="mb-0  font-weight-bold"> An optimised design for viaduct bearings using Full-Joints Two-Bearings System for efficient and effective operation and maintenance that has minimal impact to road operation and safety of road users. </p>
    </div>
  </div>
  <nav>
    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
      ...
      <a class="nav-link link-impact active text-decoration-none" id="nav-impact-tab" href="/minister-value-for-money-award/VD2/impact/"> IMPACT</a>
    </div>
  </nav>
</div>