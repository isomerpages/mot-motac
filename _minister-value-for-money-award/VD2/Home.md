      ...
      <div class="row py-5">
        <div class="col-sm-6 mb-5">
          <div class="row">
            ...
            <div class="col-sm-6">
              <p class="mb-2 text-pri font-weight-bold"> Paul Fok </p>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <p class="mb-2 text-pri font-weight-bold"> Choo Chai Foong </p>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <p class="mb-2 text-pri font-weight-bold"> Neo Bian Hong </p>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <p class="mb-2 text-pri font-weight-bold"> Goh Kok Hun </p>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <p class="mb-2 text-pri font-weight-bold"> Jeyatharan Kumarasamy </p>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <p class="mb-2 text-pri font-weight-bold"> Kenneth Liew </p>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <p class="mb-2 text-pri font-weight-bold"> Novilia Silman </p>
            </div>
          </div>
        </div>
        <div class="col-sm-6 mb-5">
          <div class="row">
            ...
            <div class="col-sm-6">
              <p class="mb-2 text-pri font-weight-bold"> Jemmy Patras </p>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <p class="mb-2 text-pri font-weight-bold"> Sim Yuan Teng, Nicholas </p>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <p class="mb-2 text-pri font-weight-bold"> Ma Wei </p>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <p class="mb-2 text-pri font-weight-bold"> Lee Eng Ming </p>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <p class="mb-2 text-pri font-weight-bold"> David Chen </p>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <p class="mb-2 text-pri font-weight-bold"> Basant Kumar </p>
            </div>
          </div>
        </div>
      </div>
